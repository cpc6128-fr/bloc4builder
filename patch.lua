...
minetest.register_lbm({
	...
	nodenames = {"bloc4builder:switch_off", "bloc4builder:switch_on", "bloc4builder:light_up", "bloc4builder:light_off", "bloc4builder:glass", "bloc4builder:glass_angle", "bloc4builder:panneaux", "bloc4builder:rail_signal_green", "bloc4builder:rail_signal_red"},
